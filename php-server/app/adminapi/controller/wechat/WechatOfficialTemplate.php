...
class WechatOfficialTemplate extends BaseAdminController
{
    /**
     * @OA\Get(
     *     path="/adminapi/wechat/official/template/list",
     *     summary="获取微信公众号模板列表",
    ...
    /**
     * @OA\Post(
     *     path="/adminapi/wechat/official/template/sync",
     *     summary="同步微信公众号模板",
     *     tags={"admin-api/wechat/WechatOfficialTemplate"},
     *     @OA\RequestBody(
     *         required=true,
    ...
    /**
     * @OA\Post(
     *     path="/adminapi/wechat/official/template/delete",
     *     summary="删除微信公众号模板配置",
     *     tags={"admin-api/wechat/WechatOfficialTemplate"},
     *     @OA\RequestBody(
     *         required=true,
     *         description="删除参数",
     *         @OA\JsonContent(
     *             @OA\Property(property="key", type="string", description="模板key")
     *         )
     *     ),
     *     @OA\Response(
     *         response=200,
     ...
     * )
     */
    public function deleteWechatOfficialTemplate()
    {
        $key = input('param.key', '');
