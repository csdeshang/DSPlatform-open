 ...
 *
 * 说明：
 * - 用户评论商品成功后，根据系统配置给予用户积分奖励
 * - 配置检查在 Listener 层完成，避免不必要的任务入队
 * - 内部调用 DeshangUserPointsService::addPointsForUserGoodsComment() 处理
 */
class UserGoodsCommentPointsQueue implements QueueHandlerInterface
{
    /**
     * 执行业务处理
     *
