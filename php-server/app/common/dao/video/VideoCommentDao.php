...
class VideoCommentDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateVideoComment(array $condition, array $data): int
    {
     ...
     * @return array 评论信息
     */
    public function getVideoCommentInfo(array $condition, string $field = '*', bool $lock = false): array
    {
