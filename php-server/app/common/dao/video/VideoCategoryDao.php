...
class VideoCategoryDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateVideoCategory(array $condition, array $data): bool
    {
     ...
     * @return array 分类信息
     */
    public function getVideoCategoryInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 分类信息
     */
    public function getVideoCategoryInfoById(int $id, string $field = '*'): array
    {
