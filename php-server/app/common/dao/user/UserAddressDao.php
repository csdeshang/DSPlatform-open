...
class UserAddressDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateAddress(array $condition, array $data): int
    {
     ...
     * @return array 地址信息
     */
    public function getAddressInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 地址信息
     */
    public function getAddressInfoById(int $id, string $field = '*', bool $lock = false): array
    {
