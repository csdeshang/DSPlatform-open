...
class UserDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateUser(array $condition, array $data): int
    {
     ...
     * @return array 用户信息
     */
    public function getUserInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 用户信息
     */
    public function getUserInfoById(int $id, string $field = '*', bool $lock = false): array
    {
