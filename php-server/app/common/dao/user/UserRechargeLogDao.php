...
class UserRechargeLogDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateRechargeLog(array $condition, array $data): int
    {
     ...
     * @return array 日志信息
     */
    public function getRechargeLogInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 日志信息
     */
    public function getRechargeLogInfoById(int $id, string $field = '*', bool $lock = false): array
    {
