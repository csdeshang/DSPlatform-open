...
class UserIdentityDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateUserIdentity(array $condition, array $data): int
    {
     ...
     * @return array 身份信息
     */
    public function getUserIdentityInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 身份信息
     */
    public function getUserIdentityInfoById(int $id, string $field = '*', bool $lock = false): array
    {
