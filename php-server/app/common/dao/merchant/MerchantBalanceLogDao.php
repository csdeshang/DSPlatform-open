...
use app\common\model\merchant\MerchantBalanceLogModel;
 ...
 * 负责商户余额变动日志的数据库交互操作
 */
class MerchantBalanceLogDao extends BaseDao
{
    /**
     * 构造函数
     * 
     * 初始化MerchantBalanceLogModel模型实例
     */
    public function __construct()
    {
        parent::__construct();
        $this->model = new MerchantBalanceLogModel();
    }
     ...
     * @return bool 是否更新成功
     */
    public function updateBalanceLog(array $condition, array $data): bool
    {
     ...
     * @return array 日志信息
     */
    public function getBalanceLogInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 日志信息
     */
    public function getBalanceLogInfoById(int $id, string $field = '*'): array
    {
