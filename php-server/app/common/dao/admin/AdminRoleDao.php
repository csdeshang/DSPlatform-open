...
class AdminRoleDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateAdminRole(array $condition, array $data): bool
    {
     ...
     * @return array 角色信息
     */
    public function getAdminRoleInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 角色信息
     */
    public function getAdminRoleById(int $id, string $field = '*'): array
    {
