...
class AdminLogsDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateAdminLogs(array $condition, array $data): int
    {
     ...
     * @return array 日志信息
     */
    public function getAdminLogsInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 日志信息
     */
    public function getAdminLogsInfoById(int $id, string $field = '*', bool $lock = false): array
    {
