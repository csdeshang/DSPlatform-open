...
class AdminMenuDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateAdminMenu(array $condition, array $data): bool
    {
     ...
     * @return array 菜单信息
     */
    public function getAdminMenuInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 菜单信息
     */
    public function getAdminMenuById(int $id, string $field = '*'): array
    {
