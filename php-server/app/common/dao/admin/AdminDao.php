...
class AdminDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateAdmin(array $condition, array $data): bool
    {
     ...
     * @return array 管理员信息
     */
    public function getAdminInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 管理员信息
     */
    public function getAdminInfoById(int $id, string $field = '*'): array
    {
