...
class TblGoodsBrandDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateGoodsBrand(array $condition, array $data): bool
    {
     ...
     * @return array 品牌信息
     */
    public function getGoodsBrandInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 品牌信息
     */
    public function getGoodsBrandById(int $id, string $field = '*'): array
    {
