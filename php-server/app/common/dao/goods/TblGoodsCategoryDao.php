...
class TblGoodsCategoryDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateGoodsCategory(array $condition, array $data): bool
    {
     ...
     * @return array 分类信息
     */
    public function getGoodsCategoryInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 分类信息
     */
    public function getGoodsCategoryById(int $id, string $field = '*'): array
    {
