...
class TblGoodsUserdiscountDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateGoodsUserdiscount(array $condition, array $data): bool
    {
     ...
     * @return array 会员价格信息
     */
    public function getGoodsUserdiscountInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 会员价格信息
     */
    public function getGoodsUserdiscountById(int $id, string $field = '*'): array
    {
