...
class TblGoodsSpecDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateGoodsSpec(array $condition, array $data): int
    {
     ...
     * @return array 规格信息
     */
    public function getGoodsSpecInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 规格信息
     */
    public function getGoodsSpecInfoById(int $id, string $field = '*', bool $lock = false): array
    {
