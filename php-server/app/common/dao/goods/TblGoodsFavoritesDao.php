...
class TblGoodsFavoritesDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateGoodsFavorites(array $condition, array $data): bool
    {
     ...
     * @return array 收藏信息
     */
    public function getGoodsFavoritesInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 收藏信息
     */
    public function getGoodsFavoritesById(int $id, string $field = '*'): array
    {
