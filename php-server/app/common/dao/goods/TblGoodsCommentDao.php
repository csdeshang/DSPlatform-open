...
class TblGoodsCommentDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateGoodsComment(array $condition, array $data): bool
    {
     ...
     * @return array 评论信息
     */
    public function getGoodsCommentInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 评论信息
     */
    public function getGoodsCommentById(int $id, string $field = '*'): array
    {
