...
class EditablePageDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateEditablePage(array $condition, array $data): int
    {
     ...
     * @return array 页面信息
     */
    public function getEditablePageInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 页面信息
     */
    public function getEditablePageById(int $id, string $field = '*', bool $lock = false): array
    {
