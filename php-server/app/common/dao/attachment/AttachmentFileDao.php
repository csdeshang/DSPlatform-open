...
class AttachmentFileDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateAttachmentFile(array $condition, array $data): int
    {
     ...
     * @return array 附件文件信息
     */
    public function getAttachmentFileInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 附件文件信息
     */
    public function getAttachmentFileById(int $id, string $field = '*', bool $lock = false): array
    {
