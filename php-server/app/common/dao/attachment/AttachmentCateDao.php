...
class AttachmentCateDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateAttachmentCate(array $condition, array $data): int
    {
     ...
     * @return array 附件分类信息
     */
    public function getAttachmentCateInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 附件分类信息
     */
    public function getAttachmentCateById(int $id, string $field = '*', bool $lock = false): array
    {
