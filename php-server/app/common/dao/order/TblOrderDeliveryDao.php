...
class TblOrderDeliveryDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateOrderDelivery(array $condition, array $data): int
    {
     ...
     * @return array 配送信息
     */
    public function getOrderDeliveryInfo(array $condition, string $field = '*', bool $lock = false): array
    {
