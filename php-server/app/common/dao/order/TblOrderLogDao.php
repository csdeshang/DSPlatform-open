...
class TblOrderLogDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateOrderLog(array $condition, array $data): int
    {
     ...
     * @return array 日志信息
     */
    public function getOrderLogInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 日志信息
     */
    public function getOrderLogInfoById(int $id, string $field = '*', bool $lock = false): array
    {
