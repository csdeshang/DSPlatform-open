...
class TblOrderRefundDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateOrderRefund(array $condition, array $data): bool
    {
     ...
     * @return array 退款信息
     */
    public function getOrderRefundInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 退款信息
     */
    public function getOrderRefundInfoById(int $id, string $field = '*'): array
    {
