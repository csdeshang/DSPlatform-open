...
class TblOrderRefundLogDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateOrderRefundLog(array $condition, array $data): bool
    {
     ...
     * @return array 日志信息
     */
    public function getOrderRefundLogInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 日志信息
     */
    public function getOrderRefundLogInfoById(int $id, string $field = '*'): array
    {
