...
class TblOrderFinanceDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateOrderFinance(array $condition, array $data): int
    {
     ...
     * @return array 财务记录信息
     */
    public function getOrderFinanceInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 财务记录信息
     */
    public function getOrderFinanceInfoById(int $id, string $field = '*', bool $lock = false): array
    {
