...
class TblOrderGoodsDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateOrderGoods(array $condition, array $data): int
    {
     ...
     * @return array 商品信息
     */
    public function getOrderGoodsInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 商品信息
     */
    public function getOrderGoodsInfoById(int $id, string $field = '*', bool $lock = false): array
    {
