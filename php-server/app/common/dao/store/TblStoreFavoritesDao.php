...
class TblStoreFavoritesDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateStoreFavorites(array $condition, array $data): int
    {
     ...
     * @return array 收藏信息
     */
    public function getStoreFavoritesInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 收藏信息
     */
    public function getStoreFavoritesById(int $id, string $field = '*', bool $lock = false): array
    {
