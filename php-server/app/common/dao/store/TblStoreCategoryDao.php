...
class TblStoreCategoryDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateStoreCategory(array $condition, array $data): int
    {
     ...
     * @return array 分类信息
     */
    public function getStoreCategoryInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 分类信息
     */
    public function getStoreCategoryById(int $id, string $field = '*', bool $lock = false): array
    {
