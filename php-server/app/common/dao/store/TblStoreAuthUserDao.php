...
class TblStoreAuthUserDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateStoreAuthUser(array $condition, array $data): bool
    {
     ...
     * @return array 授权用户信息
     */
    public function getStoreAuthUserInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 授权用户信息
     */
    public function getStoreAuthUserInfoById(int $id, string $field = '*'): array
    {
