...
class SysErrorLogsDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateErrorLog(array $condition, array $data): int
    {
     ...
     * @return array 日志信息
     */
    public function getErrorLogInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 日志信息
     */
    public function getErrorLogInfoById(int $id, string $field = '*', bool $lock = false): array
    {
