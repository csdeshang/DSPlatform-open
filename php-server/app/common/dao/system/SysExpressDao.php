...
class SysExpressDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateExpress(array $condition, array $data): int
    {
     ...
     * @return array 快递公司信息
     */
    public function getExpressInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 快递公司信息
     */
    public function getExpressInfoById(int $id, string $field = '*', bool $lock = false): array
    {
