...
class SysAreaDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateArea(array $condition, array $data): int
    {
     ...
     * @return array 地区信息
     */
    public function getAreaInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 地区信息
     */
    public function getAreaInfoById(int $id, string $field = '*', bool $lock = false): array
    {
