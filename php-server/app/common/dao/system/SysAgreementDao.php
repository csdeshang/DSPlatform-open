...
class SysAgreementDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateSysAgreement(array $condition, array $data): int
    {
     ...
     * @return array 协议信息
     */
    public function getSysAgreementInfo(array $condition, string $field = '*', bool $lock = false): array
    {
