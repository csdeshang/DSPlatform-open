...
class SysConfigDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateSysConfig(array $condition, array $data): int
    {
     ...
     * @return array 配置信息
     */
    public function getSysConfigInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 配置信息
     */
    public function getSysConfigInfoById(int $id, string $field = '*', bool $lock = false): array
    {
