...
class TradePayLogDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateTradePayLog(array $condition, array $data): bool
    {
     ...
     * @return array 日志信息
     */
    public function getTradePayLogInfo(array $condition, string $field = '*'): array
    {
        return $this->model->where($condition)
        ->append(['pay_status_desc', 'source_type_desc'])
     ...
     * @return array 日志信息
     */
    public function getTradePayLogInfoById(int $id, string $field = '*'): array
    {
