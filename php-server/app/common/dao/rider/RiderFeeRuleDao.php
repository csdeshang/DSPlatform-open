...
class RiderFeeRuleDao extends BaseDao
{
     ...
     * @return bool 是否更新成功
     */
    public function updateRiderFeeRule(array $condition, array $data): bool
    {
     ...
     */
    public function getRiderFeeRuleInfo(array $condition, string $field = '*'): array
    {
     ...
     * @return array 配送费规则信息
     */
    public function getRiderFeeRuleInfoById(int $id, string $field = '*'): array
    {
