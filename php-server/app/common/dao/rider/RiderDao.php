...
class RiderDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateRider(array $condition, array $data): int
    {
     ...
     * @return array 骑手信息
     */
    public function getRiderInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 骑手信息
     */
    public function getRiderInfoById(int $id, string $field = '*', bool $lock = false): array
    {
