...
class RiderTrackDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateRiderTrack(array $condition, array $data): int
    {
     ...
     * @return array 轨迹信息
     */
    public function getRiderTrackInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 轨迹信息
     */
    public function getRiderTrackInfoById(int $id, string $field = '*', bool $lock = false): array
    {
