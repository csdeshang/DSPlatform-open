...
class TechnicianBalanceLogDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateTechnicianBalanceLog(array $condition, array $data): int
    {
     ...
     * @return array 日志信息
     */
    public function getTechnicianBalanceLogInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 日志信息
     */
    public function getTechnicianBalanceLogInfoById(int $id, string $field = '*', bool $lock = false): array
    {
