...
class TechnicianCommentDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function softDeleteTechnicianComment(array $condition): int
    {
        $data = [
            'is_deleted' => 1,
            'deleted_at' => time()
     ...
     * @return int 受影响的行数
     */
    public function updateTechnicianComment(array $condition, array $data): int
    {
        $result = $this->model::update($data, $condition);
        return $result->getNumRows();
    }
     ...
     * @return array 评论信息
     */
    public function getTechnicianCommentInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 评论信息
     */
    public function getTechnicianCommentById(int $id, string $field = '*', bool $lock = false): array
    {
