...
class TechnicianTrackDao extends BaseDao
{
     ...
     * @return int 受影响的行数
     */
    public function updateTechnicianTrack(array $condition, array $data): int
    {
     ...
     * @return array 轨迹信息
     */
    public function getTechnicianTrackInfo(array $condition, string $field = '*', bool $lock = false): array
    {
     ...
     * @return array 轨迹信息
     */
    public function getTechnicianTrackInfoById(int $id, string $field = '*', bool $lock = false): array
    {
