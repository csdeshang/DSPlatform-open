...
(41, 40, 'admin/editable/index', 'admin_editable_index', 'pages-admin/main/views/editable/index', '装修列表', 'element AddLocation', '111', 'menu', 255, 1, 1, 1741881987, 1741881987),
(42, 40, 'admin/editable/h5/edit', 'admin_editable_h5_edit', 'pages-admin/main/views/editable/h5/edit', 'H5装修编辑', 'element AlarmClock', '1111111111', 'menu', 255, 0, 1, 1741883327, 1741883327),
...
CREATE TABLE `#__editable_page` (
  ...
  `device_type` varchar(10) DEFAULT 'mobile' COMMENT '设备类型 pc-电脑端 mobile-手机端',
...
CREATE TABLE `#__rider` (
  ...
  `status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '状态 0休息 1接单 2忙碌',
...
(2, 'website', 'pc_url', 'https://dsplatform.consumer.csdeshang.com', 'PC端地址', 1737038688, NULL),
...
(31, 'website', 'pc_site_name', '德尚系统(演示使用)', 'PC站点名称', 1737038688, NULL),
(32, 'website', 'pc_site_logo', 'attachment/admin/1/image/202601/09/2026010922054469610b3827918.png', 'PC logo', 1737038688, NULL),
(41, 'website', 'h5_site_name', '德尚系统(演示使用)', 'H5名称', 1737038688, NULL),
(42, 'website', 'h5_site_logo', 'attachment/admin/1/image/202601/09/2026010922055069610b3ee7b4a.png', 'H5 LOGO', 1737038688, NULL),
