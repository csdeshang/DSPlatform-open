<template>
    <el-dialog v-model="dialogVisible" :title="popTitle" width="800px" :destroy-on-close="true">
        ...
        <el-alert type="info" :closable="false" show-icon>
            ...
            <p>2. 信息请妥善保管，避免泄露</p>
            <p>3. 浏览器（AK）请使用高德地图开放平台申请。<a href="https://lbs.amap.com/" target="_blank">https://lbs.amap.com/</a></p>
        </el-alert>
        <el-form :model="formData" label-width="180px" ref="formRef" :rules="formRules" v-loading="loading">
            ...
            <el-form-item label="浏览器KEY" prop="config.browser_key">
                <el-input v-model="formData.config.browser_key" placeholder="请输入浏览器KEY"   type="password" show-password/>
            </el-form-item>

            <el-form-item label="浏览器密钥" prop="config.browser_secret">
                <el-input v-model="formData.config.browser_secret" placeholder="请输入浏览器密钥" type="password" show-password />
            </el-form-item>

            <el-form-item label="服务端KEY" prop="config.service_key">
                <el-input v-model="formData.config.service_key" placeholder="请输入服务端KEY"  type="password" show-password />
            </el-form-item>
