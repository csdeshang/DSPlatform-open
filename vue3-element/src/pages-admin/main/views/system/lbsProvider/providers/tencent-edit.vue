<template>
    <el-dialog v-model="dialogVisible" :title="popTitle" width="800px" :destroy-on-close="true">
        ...
        <el-alert type="info" :closable="false" show-icon>
            ...
            <p>2. 信息请妥善保管，避免泄露</p>
            <p>3. 浏览器（AK）请使用腾讯地图开放平台申请。<a href="https://lbs.qq.com/" target="_blank">https://lbs.qq.com/</a></p>
        </el-alert>
        <el-form :model="formData" label-width="180px" ref="formRef" :rules="formRules" v-loading="loading">
            ...
            <el-form-item label="腾讯地图Key" prop="config.service_key">
                <el-input v-model="formData.config.service_key" placeholder="请输入腾讯地图Key"  type="password" show-password />
            </el-form-item>
