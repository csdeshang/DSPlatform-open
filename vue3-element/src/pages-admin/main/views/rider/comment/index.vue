        ...
        <el-card shadow="never" class="mb-[10px]">
            <el-form :model="searchParams" inline>
                ...
                <el-form-item label="评价状态">
                    <el-select v-model="searchParams.is_show" placeholder="请选择评价状态" clearable style="width: 120px">
                        <el-option label="显示中" value="1" />
                        <el-option label="已隐藏" value="0" />
                    </el-select>
                </el-form-item>
                <el-form-item label="回复状态">
                    <el-select v-model="searchParams.is_reply" placeholder="请选择回复状态" clearable style="width: 120px">
        ...
        <el-card shadow="never">
            <el-table :data="tableData.data" size="large" v-loading="tableData.loading">
                ...
                <el-table-column label="骑手信息" min-width="120">
                    <template #default="{ row }">
                        <div class="flex items-center">
                            <span class="text-blue-500 cursor-pointer" @click="handleRiderDtail(row.rider_id)">{{
                                row.rider.name }}
                            </span>
                        </div>
                    </template>
...
<script setup lang="ts" name="RiderCommentIndex">
import { reactive, ref } from 'vue'
import { getRiderCommentPages, toggleRiderCommentField } from '@/pages-admin/main/api/rider/riderComment'
...
const {
    ...
    page_current: 1,
    page_size: 20,
    requestFun: getRiderCommentPages,
