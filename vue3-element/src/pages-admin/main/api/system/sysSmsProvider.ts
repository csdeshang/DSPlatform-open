...
// 短信服务商详情
export function getSmsProviderInfo(params: Record<string, any>) {
    return request.get(`${API_BASE_URLS.ADMIN}/system/sms/provider/info`, { params });
}

// 短信服务商配置更新 
export function updateSmsProviderConfig(params: Record<string, any>) {
    return request.post(`${API_BASE_URLS.ADMIN}/system/sms/provider/update`, params)
}
