<template>
    <!-- 详情页中显示成长记录列表   根据用户ID 显示成长记录 显示 TblUserGrowthLog 表中的数据 -->
    ...
    <el-table :data="tableData.data" style="width: 100%" v-loading="tableData.loading">
        ...
        <el-table-column label="变动成长值" width="100">
            <template #default="{ row }">
        ...
        <el-table-column prop="before_num" label="变动前成长值" width="120" />
        <el-table-column prop="after_num" label="变动后成长值" width="120" />
